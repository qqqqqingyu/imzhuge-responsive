        ...
        <el-row>
          <el-col :span="24">
            <el-breadcrumb separator-class="el-icon-arrow-right" style="font-size: 15px">
              ...
              <el-breadcrumb-item>{{ industryDetail.industry }}行业个股收益</el-breadcrumb-item>
            </el-breadcrumb>
          </el-col>
        </el-row>
        <el-row>
          <el-col :span="10" class="title-left">
            <div class="title-box">
              {{ industryDetail.industry }}行业{{ industryDetail.start_day }}至{{ industryDetail.end_day }}周度收益率排名预测
            </div>
          </el-col>
        </el-row>
                ...
                <el-row style="text-align: left">
                    ...
                    <el-form-item label="请选择您预测排名第一的公司：">
                      <el-radio-group v-model="inputNo1">
                        <el-radio class="radio-mb" v-for="item in companyRankData" :key="item.company_contract_id"
                                  :label="item.company_contract_id">{{ item.company_name }}
                        </el-radio>
                      </el-radio-group>
                    </el-form-item>
                  </el-col>
                  ...
                  <el-col :offset="1" :span="22">
                    <el-form-item label="交易份额：" label-width="20%">
                      <el-input type="text" v-model.number="tradeCount" label-width="70%" placeholder="输入整数"
                  ...
                  <el-col :offset="1" :span="22">
                    <el-form-item label="交易理由：" label-width="20%">
                      <el-input label-width="70%" :rows="2" type="textarea" v-model="note"
                                placeholder="可以说说您为什么要这么交易吗"/>
                    </el-form-item>
                  </el-col>
